...
(function () {
  ...
  const translations = {
    en: {
      ...
      'hero.pre': 'Together with their families, Amer Abu Obaideh and Munir al-Zaqqa invite you to celebrate the wedding of',
      'hero.invite': '',
      'hero.month': 'August',
      ...
      'timeline.arrival.title': 'Start of Party',
    ...
    ar: {
      ...
      'hero.name.and': 'و',
      'hero.name.yazan': 'يزن',
      'hero.pre': 'يتشرف كل من المهندس عامر أبوعبيدة والدكتور منير الزقّة بدعوتكم لحفل زفاف',
      'hero.invite': '',
      'hero.month': 'أغسطس',
